...
export default function EditModal({ isOpen, setIsOpen, userId }) {
  const form = useRef({});
  ...
  const handleEdit = async (ev) => {
    ...
    const response = await axios.post('/api/updateUser', formValues);
      ...
      <div className='modal-inner'>
        <div className='modal-container'>
          ...
          <div className='modal-footer'>
            <button className='btn btn-modal btn-confirm' onClick={handleEdit}>
              Confirm
            </button>
