...
export default function UserItem({ user, setIsEditOpen, setIsDeleteOpen }) {
    return (
        <li className="user-item">
            <div className="actions">
                <div className="delete-wrap" onClick={(e) => setIsDeleteOpen(true)}>
                ...
                <div className="edit-wrap" onClick={(e) => setIsEditOpen(true)}>
            ...
            <p className="user-first">{user.firstName}</p>
            <p className="user-last">{user.lastName}</p>
